    ...
    <div class="wrapper">
        <main class="main">
                ...
                <div class="container">
                    <div class="top__wrapper">
                        <div class="top__content">
                            <p class="top__content-subtitle">Welcome to Foodhub</p>
                            <h1 class="top__content-title">Enjoy Healthy
                                & Tasty Food</h1>
                ...
                <div class="container">
                    <div class="about__wrapper">
                        ...
                        <div class="about__content">
                            <h2 class="about__title">Serving Best Food is Our First Priority</h2>
                            <p class="about__text">nutrients used in the body of an organism to sustain growth and vital processes and to furnish energy. The absorption and utilization of food by the body is fundamental to nutrition and is facilitated by digestion</p>
                            <button class="about__btn">Learn About Us</button>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="offer__items">
                        <div class="offer__item">
                            ...
                            <div class="offer__item-down">
                                <h3 class="offer__item-title">Local/Traditional Food</h3>
                                <p class="offer__item-text">It is a long established fact that a reader will be distracted by the
                        ...
                        <div class="offer__item">
                            ...
                            <div class="offer__item-down">
                                <h3 class="offer__item-title">Inter/Continental Food</h3>
                                <p class="offer__item-text">It is a long established fact that a reader will be distracted by the
                                    readable content of a page when looking at its layout.</p>
                            </div>
                        </div>
                        <div class="offer__item">
                            ...
                            <div class="offer__item-down">
                                <h3 class="offer__item-title">Fastfood</h3>
                                <p class="offer__item-text">It is a long established fact that a reader will be distracted by the
                                    readable content of a page when looking at its layout.</p>
                            </div>
                        </div>
            ...
            <section class="discount">
                <div class="container">
                    <h2 class="discount__title">Up to <span>50%</span> Discount on Selected Items</h2>
                    <p class="discount__text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                    <div class="discount__buttons">
                        <a href="#" class="discount__items-btn">All Discount Item</a>
                        <a href="#" class="discount__menu-btn">View All Menu</a>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="app__wrapper">
                        <div class="app__content">
                            <h3 class="app__content-title">Easiest way to get your food by our app</h3>
        ...
        <div class="container">
            <div class="footer__wrapper">
                ...
                <div class="footer__menu">
                    <nuxt-link to="/MenuPage" class="footer__menu-link">
